...
FMathDocumentState* MathDocumentCanvas::getCanvasState()
{
	return m_node->getCanvasState();
}
...
FMathDocumentState* CustomTextureNodePrivate::getCanvasState()
{
	return m_documentRendering.getState();
}
